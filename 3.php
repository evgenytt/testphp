...
class provider1 implements logistics {
...
class provider2 implements logistics {
    public $name = 'DHL';
    public function getCost($weight) {
        return $weight*100;
    }
...
echo $provider1->name.PHP_EOL.$provider1->getCost($weight).PHP_EOL;
echo $provider2->name.PHP_EOL.$provider2->getCost($weight).PHP_EOL;